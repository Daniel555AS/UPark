...
public class AddVisitor extends JFrame {
	...
	public AddVisitor() {
		...
		RoundedButton siguienteButton = new RoundedButton("SIGUIENTE", new Color(255, 239, 91), new Color(247, 208, 57),
				1000);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (text1.equals("") || text1.length() == 0 || text2.equals("") || text2.length() == 0) {
					...
					try {
						...
						JOptionPane.showMessageDialog(null, "Datos del Visitante Guardados con Éxito", "VISITANTE",
